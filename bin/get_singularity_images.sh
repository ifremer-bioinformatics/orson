...
if [ ! -f "$container_dir/beedeem-4.7.0.sif" ] && [ ! -f "$container_dir/diamond-2.0.9.sif" ] && [ ! -f "$container_dir/iprscan-5.51-85.0.sif" ] && [ ! -f "$container_dir/blast-2.10.0.sif" ] && [ ! -f "$container_dir/eggNOG-mapper-2.1.0.sif" ] && [ ! -f "$container_dir/busco-5.1.2.sif" ]
then
